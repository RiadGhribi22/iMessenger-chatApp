...
const VoiceChatComponent = () => (
  <svg viewBox="0 0 130 40">
    <defs>
      <style>
        {
          ".a20{fill:#76c00d;}.b20{fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}.c20{fill:#fff;font-size:14px;font-family:Helvetica;}"
        }
      </style>
    </defs>
    <rect className="a20" width={130} height={40} rx={20} />
    <path
      className="b20"
      ...
      transform="translate(17.005 10.108)"
    />
    <text className="c20" transform="translate(112 25)">
      <tspan x={-64.606} y={0}>
        {"Voice chat"}
      </tspan>
    </text>
