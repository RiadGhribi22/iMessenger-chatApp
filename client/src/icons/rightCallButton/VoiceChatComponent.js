...
const VoiceChatComponent = () => (
  <svg viewBox="0 0 130 40">
    <defs>
      <style>
        {
          ".a{fill:#76c00d;}.b{fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}.c{fill:#fff;font-size:14px;font-family:Helvetica;}"
        }
      </style>
    </defs>
    ...
    />
    <text className="c" transform="translate(112 25)">
      <tspan x={-64.606} y={0}>
        {"Voice chat"}
      </tspan>
    </text>
